 ...
 */
package com.sunekaer.mods.sdrp.discord.discordipc.exceptions;

import com.sunekaer.mods.sdrp.discord.discordipc.entities.DiscordBuild;

/**
 * An exception thrown when an {@link com.sunekaer.mods.sdrp.discord.discordipc.IPCClient IPCClient}
 * when the client cannot find the proper application to use for RichPresence when
 * attempting to {@link com.sunekaer.mods.sdrp.discord.discordipc.IPCClient#connect(DiscordBuild...) connect}.<p>
 * <p>
